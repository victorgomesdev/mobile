    ...
    <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
      <ScrollView>
        <View style={{ alignItems: 'center', justifyContent: 'center', padding: 25 }}>
          <View style={{ backgroundColor: 'brown', margin: 10, borderRadius: 10 }}>
            <Image style={{ resizeMode: 'contain', width: 100, height: 100, margin: 10 }} source={require('../assets/img/ponte.png')}></Image>
          </View>
